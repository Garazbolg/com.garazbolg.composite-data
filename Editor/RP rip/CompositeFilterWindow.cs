...
//  Copied from https://raw.githubusercontent.com/Unity-Technologies/Graphics/master/Packages/com.unity.render-pipelines.core/Editor/FilterWindow.cs
//  To prevent dependancy
...
/// </summary>
[InitializeOnLoad]
public class CompositeFilterWindow : EditorWindow
{
    /// <summary>
    ...
    public class GroupElement : Element
    {
        ...
        public virtual bool HandleKeyboard(Event evt, CompositeFilterWindow window, Action goToParent)
        {
            return false;
        }
        ...
        public virtual bool OnGUI(CompositeFilterWindow sFilterWindow)
        {
            return false;
        }
    }
    ...
    static CompositeFilterWindow s_FilterWindow;
    ...
    public static bool Show(Vector2 position, IProvider provider)
    {
        ...
        var wins = Resources.FindObjectsOfTypeAll(typeof(CompositeFilterWindow));
        if (wins.Length > 0)
        {
            try
            {
        ...
        if (!justClosed)
        {
            ...
            {
                s_FilterWindow = CreateInstance<CompositeFilterWindow>();
